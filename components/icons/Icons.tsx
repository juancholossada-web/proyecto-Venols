...
export function IconShip({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 17l1.5 3.5A1 1 0 0 0 5.4 21h13.2a1 1 0 0 0 .9-.5L21 17" />
...
export function IconFuel({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 22V8a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v14" />
      <path d="M13 9h3a2 2 0 0 1 2 2v3a2 2 0 0 0 2 2v0a2 2 0 0 0 2-2V8l-3-3" />
...
export function IconBuilding({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M11 7V4a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v17H11" />
      <line x1="6" y1="10" x2="6" y2="10" /><line x1="6" y1="13" x2="6" y2="13" /><line x1="6" y1="16" x2="6" y2="16" />
      <line x1="15" y1="7" x2="15" y2="7" /><line x1="15" y1="10" x2="15" y2="10" /><line x1="15" y1="13" x2="15" y2="13" />
    </svg>
  )
}
